...
\newacronym{rssi}{RSSI}{Received Signal Strength Indicatior}
\newacronym{cccd}{CCCD}{Client Characteristic Configuration Descriptor}
\newacronym{wsn}{WSN}{Wireless Sensor Network}
\newacronym{sn}{SN}{Sequence Number}
\newacronym{nesn}{NESN}{Next Expected Sequence Number}
\newacronym{md}{MD}{More Data}